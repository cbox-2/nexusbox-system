...
var mnucont={
  ...
  2:'<a href="#">Posting options</a><a href="#">Date options</a><a href="#">Emoticons</a><a href="#">Filtering</a>',
...
// ===== Common Functions =====
function selectAll(){
  document.querySelectorAll('.user-row input[type=checkbox]').forEach(function(c){c.checked=true;});
}
