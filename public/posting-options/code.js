...
var mnucont={
  ...
  2:'<a href="/posting-options/posting-options.html">Posting options</a><a href="#">Date options</a><a href="#">Emoticons</a><a href="#">Filtering</a>',
...
// ===== Posting Options Specific =====
function chksound(){
  var f=document.forms["settings"];
  if(!f)return;
  var soundSelect=f["sound"];
  if(!soundSelect)return;
  if(soundSelect[soundSelect.selectedIndex].value=="-1"){
    document.getElementById("sound_custom").style.display="";
  }else{
    document.getElementById("sound_custom").style.display="none";
  }
}

function chk_settings(){
  var msg=document.getElementById('m_settings');
  if(msg){
