...
var mnucont={
  ...
  4:'<a href="#">Messages</a><a href="#">Archives</a><a href="#">Sticky message</a><a href="#">Channels</a><a href="/webhook/index.html">Webhook</a>'
};
...
function chk_webhook(){
  ...
  var msg=document.getElementById('m_webhook');
  if(msg){
