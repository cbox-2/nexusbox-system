...
const { securityHeaders, apiRateLimit, securityErrorHandler } = require('./src/middleware/security-routes');
...
// ============================================
// BOX ROUTES (New System)
// ============================================
app.use('/api/boxes', apiRateLimit(60000, 30), boxRoutes);

// Get box by embedKey (public endpoint for embed)
app.get('/api/embed/:embedKey', require('./src/controllers/boxController').getBoxByEmbedKey);
